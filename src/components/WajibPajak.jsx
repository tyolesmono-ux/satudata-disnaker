...
import { FormContainer, InputField, SelectField, ConfirmDialog } from './SharedUI';
...
export const FormPegawaiASN = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setConfirmDialog({
      show: true,
      title: 'Simpan Pegawai ASN',
      message: `Apakah Anda yakin ingin menyimpan data Pegawai ASN "${formData.nama}" (NIP: ${formData.nip})?`,
      onConfirm: async () => {
...
export const FormWPPribadi = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setConfirmDialog({
      show: true,
      title: 'Simpan WP Pribadi',
      message: `Apakah Anda yakin ingin menyimpan data WP Pribadi "${formData.nama}" (NIK: ${formData.nik})?`,
      onConfirm: async () => {
        setConfirmDialog(prev => ({ ...prev, show: false }));
...
export const FormWPPihakKetiga = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setConfirmDialog({
      show: true,
      title: 'Simpan WP Pihak Ketiga',
      message: `Apakah Anda yakin ingin menyimpan data WP Pihak Ketiga "${formData.nama_usaha}" (Pemilik: ${formData.nama_pemilik})?`,
      onConfirm: async () => {
        setConfirmDialog(prev => ({ ...prev, show: false }));
